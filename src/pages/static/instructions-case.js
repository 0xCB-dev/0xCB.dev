          ...
          <div className="row">
            <div className="col-6 col-12-medium">
              <p>
                ...
                <br />
                <br />
                The process of assembling the case is quite straight forward,
                however you need to put the Plates together in the right order.
                <br />
                <br />
      ...
      <section id="parts" className="wrapper style2">
        <div className="inner">
          <div className="content">
            ...
            <p>These parts should all be included in you Static Acrylic Case Kit!</p>
