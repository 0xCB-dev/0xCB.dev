      ...
      <div className="wrapper">
        <div className="inner">
          <p>
            ...
            <a href="https://0xcb.dev">https://0xcb.dev</a> and any related
            services provided by 0xCB.{' '}
          </p>
          <p>
            By accessing <a href="https://0xcb.dev">https://0xcb.dev</a>, you
            ...
            website or using any other services provided by 0xCB.{' '}
          </p>
          <p>
            We, 0xCB, reserve the right to review and amend any of these Terms
          ...
          <p>These Terms of Service were last updated on 21 July 2021. </p>
          ...
          <p>
            ...
            are owned by or licensed to 0xCB and are protected by applicable
          ...
          <p>
            ...
            is' basis. To the extent permitted by law, 0xCB makes no warranties,
          ...
          <p>
            In no event shall 0xCB or its suppliers be liable for any
            ...
            materials on this website, even if 0xCB or an authorized
          ...
          <p>
            ...
            for general information purposes only. 0xCB does not warrant or make
          ...
          <h2>Links</h2>
          <p>
            0xCB has not reviewed all of the sites linked to its website and is
            not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement, approval, or
            control by 0xCB of the site. Use of any such linked site is at your
          ...
          <p>
            ...
            with the laws of Germany. You irrevocably submit to the exclusive
