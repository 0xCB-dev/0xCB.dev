    ...
    <section id="wrapper">
      ...
      <div className="wrapper">
        <div className="inner">
          ...
          <p>This policy was last reviewed on 21 July 2021. </p>
          <h2>Fair use</h2>
          <p>
          ...
          <p>
            ...
            permission of the email address or telephone number owner, and
            storing any email addresses or telephone numbers subscribed in this
            way. All messaging lists run on or hosted by our Products must be
          ...
          <h3>Unauthorized use of 0xCB property</h3>
          <p>
            We prohibit the impersonation of 0xCB, the representation of a
            significant business relationship with 0xCB, or ownership of any
            0xCB property (including our Products and brand) for the purpose of
