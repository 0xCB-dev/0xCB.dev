              ...
              <div className="content">
                ...
                >
                  <blockquote>
                    ...
                    love being able to see what layer I'm on at a glance. I
                    can't wait to create a custom keymap, so that I can
                    integrate it with my daily workflow!
                    <br />
                    <br />
                    In addition to the device being great, shipping to the US
                    was much quicker than I anticipated and the creators have
                    been very responsive and a pleasure to chat with. They
                    honestly care how their customers feel about their product
                    and about the product itself. I would definitely purchase
                    another of their products in the future!
                  </blockquote>
                  <p>April 26, 2021</p>
                </a>
              </div>
              <div className="content">
                ...
                >
                  <blockquote>
                    ...
                    <br />
                    Out of the box, this unit impressed us very much.
                    Understated on our busy manufacturing operations console,
                    the macropad screen provides the right amount of context to
                    the tasks at hand, and the case is well built and capable of
                    the stresses of a lot of use and 24 x7 shift operations.
                    While it is our belief that QMK was put on this Earth as a
                    torture device, fortunately this unit supports QMK's nicer
                    little sister, VIA, and makes programming and
                    reconfiguration a snap. We are in the market to replace a
                    large number of macropad type devices in our global
                    manufacturing environment and were on the verge of building
                    our own, this unit is making us rethink that strategy. Kudos
                    to the two innovators who are behind this project.
                    <br />
                    <br />
